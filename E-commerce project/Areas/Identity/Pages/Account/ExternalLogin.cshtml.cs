...
namespace E_commerce_project.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            // ✅ لو اليوزر مرتبط بالفعل بنفس الـ external login → دخلو
            ...
            {
                // ⚠️ مفيش يوزر مربوط بالـ external login → روح للصفحة بتاعة كتابة الإيميل
                ReturnUrl = returnUrl;
